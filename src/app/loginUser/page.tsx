	...
	return (
		<div className="flex min-h-screen overflow-hidden">
			...
			<motion.div
				...
				style={{
					backgroundImage:
						"url('https://foriu.mx/wp-content/uploads/2024/08/los-5-beneficios-del-maquillaje-y-peinado-a-domicilio-blog-foriu.jpg')",
			...
			>
				...
				<div className="relative z-10 text-center flex flex-col items-center max-w-sm mt-12">
					<h1 className="text-5xl font-bold mb-10 tracking-tight leading-tight">
						¡Amamos verte de nuevo!
					</h1>
			...
			{/* PANEL DERECHO (scroll + degradado + formulario) */}
			<div
